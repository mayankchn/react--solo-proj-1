...
export default function Info() {
    return(
        <div className="info-wrapper">
            <img src="../public/prof.png" alt="usr-profile" className="info-wrapper--dp" />
            ...
            <div className="info-wrapper--links">
                <a href="#" className="info-wrapper--links--link info-wrapper--links--email ">
                    <img src="../public/Mail.png" alt="main-icon" className="info-wrapper--links--email--logo" />
                ...
                <a href="#" className="info-wrapper--links--link info-wrapper--links--linkedin">
                    <img src="../public/linkedin.png" alt="linkedin-icon" className="info-wrapper--links--linkedin--logo" />
